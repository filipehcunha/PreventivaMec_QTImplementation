...
/**
 * @class MaintenanceServicePlugin
 * @brief Implementação de IMaintenanceService empacotada como DLL (Qt plugin).
 * @details Demonstra componentização: o app carrega esta DLL em runtime via QPluginLoader.
 */
...
public:
    ...
    Preventiva::MaintenanceOrder schedule(const QString& machineId,
                                          Preventiva::SchedulePolicy policy,
...
private:
    ...
    mutable QHash<QString, QVector<Preventiva::MaintenanceOrder>> m_orders; // memória (demo)
};
